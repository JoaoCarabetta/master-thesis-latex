...
\input{1.Introduction.tex}   %% remove this line to get rid of the example chapter
\input{2.Literature_review.tex}   %% remove this line to get rid of the example chapter
\input{3.Data_and_methodology.tex}   %% remove this line to get rid of the example chapter
\input{4.Results.tex}   %% remove this line to get rid of the example chapter
\input{5.Discussion.tex}   %% remove this line to get rid of the example chapter
